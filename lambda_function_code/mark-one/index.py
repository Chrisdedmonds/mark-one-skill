...
def on_intent(intent_request, session):
    ...
    if intent_name == "MarkOneInfoIntent":
        return get_mark_info_response()
    elif intent_name == "MarkMacrosIntent":
        return get_macros_response(intent_request)
...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Welcome to the mark one. How can I help you?"
...
def get_mark_info_response():

    session_attributes = {}
    card_title = "MarkOneInfo"
    speech_output = "I'm here to make counting macros a breeze."
    # If the user either does not reply to the welcome message or says something
    # that is not understood, they will be prompted again with the same text.
    reprompt_text = speech_output
    should_end_session = False
...
def get_macros_response(intent_request):

    session_attributes = {}
    card_title = "Get Macros"
    num = intent_request["intent"]["slots"]["Number"]["value"]
    uni = intent_request["intent"]["slots"]["Unit"]["value"]
    food = intent_request["intent"]["slots"]["Food"]["value"]

    speech_output = "Ok, that's " + num + " " + uni + " of " + food
